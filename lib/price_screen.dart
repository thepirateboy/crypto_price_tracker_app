      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          ElevatedButton(
              onPressed: () async {
                var url =
                    "https://api.nomics.com/v1/currencies/ticker?key=aa5c3ae90e82b87bcde0d9cfc550007aa88f0527&ids=BTC,ETH,XRP&interval=1d,30d&convert=AUD&per-page=100&page=1";
